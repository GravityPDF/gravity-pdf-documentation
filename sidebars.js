      ...
      items: [
...

        {
          ...
          'items': [
            ...
            'v6/users/where-are-the-pdfs-stored-on-the-server',
      ...
      items: [
        {
          ...
          'items': [
            ...
            'v6/developers/setasign-fpdi-pdf-parser',
          ],
          'collapsed': false,
        },
        {
        ...
        },
        {
          ...
          'items': [
            ...
            'v6/developers/filters/gfpdf_hide_consent_field_if_empty',
            ...
            'v6/developers/filters/gfpdf_mpdf_class_config',
  ...
  invoiceDeveloperSidebar: [
    {
      ...
      'items': [
        {
          type: 'autogenerated',
          dirName: 'v6/templates/hooks/invoices',
        }
      ]
    }
  ],

  pdf4gvDeveloperSidebar: [
    {
      'type': 'category',
      'label': 'PDF for GravityView',
      'items': [
        {
          'type': 'link',
          'label': 'Back to User Documentation',
          'href': '/v6/extensions/pdf-for-gravityview-add-on',
        },

        {
          ...
          'items': [
            {
              type: 'autogenerated',
              dirName: 'v6/extensions/api/pdfgv',
            }
          ],
        },

        {
          ...
          'items': [
            {
              type: 'autogenerated',
              dirName: 'v6/extensions/hooks/pdfgv',
            }
          ],
        }
      ]
      ...
      'items': [
        {
          'type': 'link',
          'label': 'Back to User Documentation',
          'href': '/v6/extensions/previewer-add-on',
        },

        {
          ...
          'items': [
            {
              type: 'autogenerated',
              dirName: 'v6/extensions/hooks/previewer',
            }
          ],
        }
      ]
