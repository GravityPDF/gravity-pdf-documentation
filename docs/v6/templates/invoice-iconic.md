...
![A screenshot of Iconic, with numbers one through thirteen positioned on the invoice area, and controlled by the numbered settings documented in the Labels section.]([https://resources.gravitypdf.com/uploads/2023/07/8-Labels-Iconic.png](https://resources.gravitypdf.com/uploads/2023/07/8-Labels-Iconic-v2.png))
