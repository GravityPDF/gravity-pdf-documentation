...
*Invoice Classic* comes bundled with *PT Serif* which is an open source licensed font (SIL Open Font License, Version 1.1). PT Serif is a transitional typeface with humanistic accents. For the best results we recommend using PT Serif at 10pt. Set the PDF font [in the Appearance tab](setup-pdf.md#appearance-tab).
