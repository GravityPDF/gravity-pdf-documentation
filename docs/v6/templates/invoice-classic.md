...
:::note
This documentation is for _Classic_ version 2.x, which adds [multi-rate tax-inclusive pricing](#enable-tax-inclusive-pricing), grouped or itemized discounts, free trial, localized dates, [EU VAT add-on](https://geekontheroad.com/eu-vat-for-gravity-forms/), and [Gravity Wiz eCommerce Fields support](#gravity-forms-ecommerce-fields). Looking for the 1.x documentation? [You can find the _Classic_ v1 docs here](../../v5/shop-pdf-template-invoice-classic.md).
:::
