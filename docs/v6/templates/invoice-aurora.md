...
![The Invoice Aurora Gravity PDF Template Design, A4 Paper, Unpaid Watermark](https://resources.gravitypdf.com/uploads/2023/07/0-Invoice-Classic-Featured-Image-v1.jpg)
...
Below you'll find detailed information about each Template setting available to _Aurora_. The invoice PDF configuration is split up into six sections:
...
_Aurora_ also has these additional template-specific settings:

#### Primary Color
* The background color for the [Invoice Title](#invoice-title-label-1), Product Table [Description column](#description-column-label-9), and [Overall Total](#overall-total-label-14).
* The default value is `#0070bd`

#### Secondary Color
* The background color for the Header section, and the Product Table column titles. 
* The default value is `#4f4f4f`

#### Summary Label
* The label displayed above the Invoice Summary section.
* The default value is "Invoice Details".

### Company Information

![A close-up screenshot of the header section of Aurora, with numbers one through seven positioned on the invoice area, and controlled by the numbered settings documented in the Company Information section.](https://resources.gravitypdf.com/uploads/2023/07/1-Company-Information-Classic.png)
...
![A close-up screenshot of the header section of Aurora, with numbers one through five positioned on the invoice area, and controlled by the numbered settings documented in the Invoice Settings section.](https://resources.gravitypdf.com/uploads/2023/07/2-Invoice-Settings-Classic.png)
...
![A close-up screenshot of the mid section of Aurora, with numbers one through five positioned on the invoice area, and controlled by the numbered settings documented in the Buyer Information section.](https://resources.gravitypdf.com/uploads/2023/07/3-Buyer-Information-Classic.png)
...
![A screenshot of Aurora, with numbers one through seven positioned on the invoice area, and controlled by the numbered settings documented in the Tax Settings section.](https://resources.gravitypdf.com/uploads/2023/07/4-Tax-Settings-Classic.png)
...
![A screenshot focused on the bottom half of Aurora, with numbers one through four positioned on the invoice area, and controlled by the numbered settings documented in the Extras section.](https://resources.gravitypdf.com/uploads/2023/07/7-Extras-Classic-v1.png)
...
![A screenshot focused on the bottom half of Aurora, and showing individual discount amounts, which can be configured with the Itemized Discounts / Coupons setting.](https://resources.gravitypdf.com/uploads/2023/07/6-Discounts-Classic.png)
...
![A screenshot of Aurora, with numbers one through fourteen positioned on the invoice area, and controlled by the numbered settings documented in the Labels section.](https://resources.gravitypdf.com/uploads/2023/07/8-Labels-Classic.png)
...
_Aurora_ comes bundled with _Quicksand_ which is an open source licensed font (SIL v1.1, Open Font License). For the best results, we recommend using _Quicksand_ at 12pt. Set the PDF font [in the Appearance section](../users/setup-pdf.md#appearance-section).
