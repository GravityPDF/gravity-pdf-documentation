...
This filter can be used to add new fields to the [security section of the General tab of the Gravity PDF settings page](../../users/global-settings.md#general). It's basically a Fields API and all validation, sanitising and saving is handled automatically for you.
