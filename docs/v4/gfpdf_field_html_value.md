...
Just be aware that the CSS Gravity PDF ships in your templates requires this particular format. If you change it you may need to write your own custom CSS to suit. In most cases [the `gfpdf_pdf_field_content` filter](https://gravitypdf.com/documentation/v4/gfpdf_pdf_field_content/) will be more suitable.
